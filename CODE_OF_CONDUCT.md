...
reported to the project maintainers through a private GitHub channel:

- Open a [private security advisory](../../security/advisories/new) on this
  repository and note in the report that it is a Code of Conduct matter, not
  a security vulnerability — maintainers monitor that channel and it is not
  publicly visible; **or**
- If you don't have a Code of Conduct concern that fits the security
  advisory flow (for example, it doesn't involve this repository directly),
  contact a maintainer through their GitHub profile's listed contact method.

We do not publish a project email address for conduct reports; GitHub's
private channels are the supported route so that reports stay confidential
by default. All complaints will be reviewed and investigated promptly and
...
or series of actions. *Consequence*: A warning with consequences for
continued behavior, including no interaction with the people involved for a
specified period.
...
of classes of individuals. *Consequence*: A permanent ban from any sort of
