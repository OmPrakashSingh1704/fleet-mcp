...
@patch("flotilla_mcp.deploy_watcher.health.time.sleep", return_value=None)
@patch("flotilla_mcp.deploy_watcher.health.requests.get")
...
@patch("flotilla_mcp.deploy_watcher.health.time.monotonic")
@patch("flotilla_mcp.deploy_watcher.health.time.sleep", return_value=None)
@patch("flotilla_mcp.deploy_watcher.health.requests.get")
