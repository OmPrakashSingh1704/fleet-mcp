...
- [ ] **Protected core touched?** (`fleet_manifest.yaml`, `flotilla_mcp/common/manifest.py`, or a `protected: true` service) — if yes, this needs CODEOWNERS approval in addition to normal review; say so explicitly here
